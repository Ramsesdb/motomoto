  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Clasificación de Mensajes</Text>
        <View style={styles.backButton} />
      </View>
      <View style={styles.body}>
        <GlassCard style={styles.comingSoon}>
          <MaterialCommunityIcons name="tag-outline" size={48} color={colors.accent.warning} />
          <Text style={styles.comingSoonTitle}>Próximamente</Text>
          <Text style={styles.comingSoonDesc}>
            La clasificación automática de mensajes estará disponible en la próxima versión.
          </Text>
        </GlassCard>
      </View>
    </SafeAreaView>
