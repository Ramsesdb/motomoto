  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Sugerencias de Respuesta</Text>
        <View style={styles.backButton} />
      </View>

      <View style={styles.body}>
        <GlassCard style={styles.comingSoon}>
          <MaterialCommunityIcons name="comment-text-outline" size={48} color={colors.accent.purple} />
          <Text style={styles.comingSoonTitle}>Próximamente</Text>
          <Text style={styles.comingSoonDesc}>
            Las sugerencias de respuesta automática estarán disponibles en la próxima versión.
          </Text>
        </GlassCard>
      </View>
    </SafeAreaView>
