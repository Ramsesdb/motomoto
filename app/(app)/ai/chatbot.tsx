  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Estado del Chatbot</Text>
        <View style={styles.backButton} />
      </View>

      <View style={styles.body}>
        <GlassCard style={styles.comingSoon}>
          <MaterialCommunityIcons name="robot" size={48} color={colors.accent.success} />
          <Text style={styles.comingSoonTitle}>Próximamente</Text>
          <Text style={styles.comingSoonDesc}>
            El panel de control del chatbot estará disponible en la próxima versión.
          </Text>
        </GlassCard>
      </View>
    </SafeAreaView>
